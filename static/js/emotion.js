const URL = "https://teachablemachine.withgoogle.com/models/ajfH_-5E0/";
        ...
        switch(prediction[0].className) {
            ...
            resultCause = "무표정을 가지고 있는 당신! 오늘은 크게 즐겁지도 그렇다고 나쁘지도 않은 하루를 보냈나요? 미지근한 물이 잔잔하게 흐르듯 평범한 표정이지만 가장 일상적이고 보람찬 표정입니다. 아니면 도도한 표정 컨셉으로 찍은 사진일수도 있구요. 만약 슬픈 일이 있었나요? 걱정마세요. 다 잘 풀릴 겁니다! 그러니 집에서 반신욕으로 스트레스를 날려버려요. "
            break;

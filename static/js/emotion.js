const URL = "https://teachablemachine.withgoogle.com/models/ajfH_-5E0/";
        ...
        switch(prediction[0].className) {
            ...
            resultCause = "명랑하고 자신감이 넘쳐있는 당신! 너무 행복하고 상큼해 보입니다. 지켜만 보고 있어도 웃음이 날 것 같은 표정이에요. 행복하면서도 들떠 있을 만큼 좋은 일이 있으셨나요? 만약 아니더라도 곧 좋은 일이 찾아올 것 같은 얼굴입니다. 주변 사람들에게 이 사진을 은근 슬쩍 보여주면 호감이 급상승 할 것 같은 예감!"
            break;

            case "까칠" :
            resultTitle = "까칠한 키위"
            resultExplain = "#시크절정 #아무도 건들지마 #도도한 매력"
            resultCause = "시크한 표정을 가지고 있는 당신! 오늘 도도하다는 말을 듣진 않았나요? 아이러니하게도 도도하고 시크한 표정을 짓고 있으면 외모가 업이 됩니다. 기분은 그렇다치고 오늘 셀카를 찍어보는 건 어떨까요? 그리고 일이나 주변 사람들 때문에 스트레스를 받고 있다면 반신욕으로 기분을 달래보는 건 어떠나요? "
            break;

            case "놀람" :
            resultTitle = "놀란 오렌지"
            resultExplain = "#리액션천국 #(ﾉ'□ﾟ) #다이나믹한 하루 #오늘 일이 많지? "
            resultCause = "놀란 표정을 가지고 있는 당신! 오늘 무슨 일이 그렇게 많았길래 놀란 표정을 하고 있나요? 아니면 컨셉으로 놀란 모습을?? 오늘이 다이나믹한 하루였다면 집에서 치킨 시켜놓고 잔잔한 영화를 보면서 힐링하는 건 어떨까요?"
            break;

            case "분노" :
            resultTitle = "짜증난 딸기"
            resultExplain = "#건들기만 해봐 #폭발한다!!!! #다 죽는다!!!!!!!!"
            resultCause = "분노한 표정을 가지고 있는 당신.. 오늘 누가 당신을 그렇게 짜증나게 만들었나요? 딱 데려오세요! 화가 나는 만큼 에너지를 쓰는 것도 좋아요! 달리기나 스포츠 같은 활동적인 활동으로 스트레스를 푸는 건 어떨까요?"
            break;
            ...
            case "슬픔" :
            resultTitle = "무표정 블루베리"
            resultExplain = "#나는 아무 생각이 없다 #왜냐면 아무 생각이 없기 때문이다" 
            resultCause = "무표정을 가지고 있는 당신! 오늘은 크게 즐겁지도 그렇다고 나쁘지도 않은 하루를 보냈나요? 미지근한 물이 잔잔하게 흐르듯 평범한 표정이지만 가장 일상적이고 보람찬 표정입니다. 아니면 도도한 표정 컨셉으로 찍은 사진일수도 있구요. 만약 슬픈 일이 있었나요? 걱정마세요. 다 물처럼 흘러가 잘 풀릴 겁니다! 그러니 집에서 반신욕으로 스트레스를 날려버려요. "
            break;
